...
$(document).ready(function($) {
	...
	// Der Tag/Nacht effekt im Hintergrund bzw. im Fenster des Mittelgrundes.
	var dayNight = TweenMax.to("#selfstudy3 > .middleground > .daynight", 1, {left: "-=100%", ease: Linear.easeNone});
	
	// Die Animationen fuer den Tisch samt Student.
	...
	// Die Zeitleiste fuer den Uhrwechsel.
	...
	// Die schwarzen Becher und anderes Geruempel das schnell im Vordergrund vorbei wischt.

...
$(document).ready(function($) {
	...
	var table2Out = TweenMax.fromTo(".table.second", 0.1, {right: "20%",bottom :"0%", }, {autoAlpha:0, delay:0.5, ease: Linear.easeNone});
	var table3In = TweenMax.fromTo(".table.third", 0.1, {right: "20%", bottom:"0%", autoAlpha:0}, {autoAlpha:1, delay:0.5, ease: Linear.easeNone});
	...
	var self3_headOut = TweenMax.to("header.self3", 0.2, {autoAlpha:0, delay:0.5});
	var self3_textOut = TweenMax.to("section.self3", 0.2, {autoAlpha:0, delay:0.5});
	
	var self3_a_headIn 	= TweenMax.fromTo("header.self3_a", 0.3, {top: "10%", left:"-80%"}, { delay:0.5 , left:"2%" ,ease: Linear.easeNone});
	var self3_a_textIn 	= TweenMax.fromTo("section.self3_a", 0.3, {top: "28%", left: "-80%" }, { delay: 0.5, left:"2%",  ease: Linear.easeNone});
	
	var self3_a_headOut = TweenMax.to("header.self3_a", 0.2, {autoAlpha:0, delay:0.7});
	var self3_a_textOut = TweenMax.to("section.self3_a", 0.2, {autoAlpha:0, delay:0.7});
	
	var self3_b_headIn 	= TweenMax.fromTo("header.self3_b", 0.3, {top: "10%", left:"-80%"}, { delay:0.7 , left:"2%" ,ease: Linear.easeNone});
	var self3_b_textIn 	= TweenMax.fromTo("section.self3_b", 0.3, {top: "28%", left: "-80%" }, { delay: 0.7, left:"2%",  ease: Linear.easeNone});
